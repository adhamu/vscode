...
function taskBatchProcess(queue) {
    return __awaiter(this, void 0, void 0, function* () {
...
function _sync(srcDir, desDir, srcFs, desFs, option = defaultSyncOption) {
...
function transportDir(src, des, srcFs, desFs, option) {
    return __awaiter(this, void 0, void 0, function* () {
        let result;
        try {
            const tasks = yield _transportDir(src, des, srcFs, desFs, option);
            result = yield taskBatchProcess(tasks);
        }
        catch (err) {
            result = [{
                    target: src,
...
function sync(srcDir, desDir, srcFs, desFs, option = defaultSyncOption) {
    return __awaiter(this, void 0, void 0, function* () {
        let result;
        try {
            const tasks = yield _sync(srcDir, desDir, srcFs, desFs, option);
            result = yield taskBatchProcess(tasks);
        }
        catch (err) {
            result = [{
...
exports.sync = sync;
function transport(src, des, srcFs, desFs, option = defaultTransportOption) {
    if (shouldSkip(src, option.ignore)) {
        return Promise.resolve([
            {
                target: src,
