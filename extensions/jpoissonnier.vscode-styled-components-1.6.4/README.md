...
![Syntax highlighting in action](https://github.com/styled-components/vscode-styled-components/raw/master/demo.gif)
...
see [Contributing](https://github.com/styled-components/vscode-styled-components/blob/master/./CONTRIBUTING.md)
