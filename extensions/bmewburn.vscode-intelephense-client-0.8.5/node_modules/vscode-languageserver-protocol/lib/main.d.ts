...
export declare namespace Proposed {
    ...
    type ImplementationClientCapabilities = implementation.ImplementationClientCapabilities;
    type ImplementationServerCapabilities = implementation.ImplementationServerCapabilities;
    namespace ImplementationRequest {
        const type: RequestType<TextDocumentPositionParams, Definition | null, void, TextDocumentRegistrationOptions>;
    }
    type TypeDefinitionClientCapabilities = typeDefinition.TypeDefinitionClientCapabilities;
    type TypeDefinitionServerCapabilities = typeDefinition.TypeDefinitionServerCapabilities;
