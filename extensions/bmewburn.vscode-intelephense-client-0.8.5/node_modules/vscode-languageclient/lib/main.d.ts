...
export declare namespace ProposedFeatures {
    ...
    type ImplementationFeature = implementation.ImplementationFeature;
    const ImplementationFeature: typeof implementation.ImplementationFeature;
    type ImplementationMiddleware = implementation.ImplementationMiddleware;
    type TypeDefinitionFeature = typeDefinition.TypeDefinitionFeature;
    const TypeDefinitionFeature: typeof typeDefinition.TypeDefinitionFeature;
    type TypeDefinitionMiddleware = typeDefinition.TypeDefinitionMiddleware;
